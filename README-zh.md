...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Discuz! Q 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://registry.hub.docker.com/_/discuzq/)）：
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| Discuz! Q | 9001 | 浏览器访问 Discuz! Q | Y |
## 文档

[MediaWiki 管理员手册](https://support.websoft9.com/docs/discuzq)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Discuz! Q 企业级支持版](https://apps.websoft9.com/discuzq) 
